...
:runDM
"%_JAVACMD%" -classpath "%LOCALCLASSPATH%" "-Ddm.home=%DM_HOME%" HttpProxyUI %*
goto end

:runDMWithJikes
"%_JAVACMD%" -classpath "%LOCALCLASSPATH%" "-Ddm.home=%DM_HOME%" "-Djikes.class.path=%JIKESPATH%" %DM_OPTS% HttpProxyUI %*
goto end
